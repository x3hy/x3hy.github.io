...
# Generate journals
new=$(plate --template="		<li><details><summary><!--\$title--> - <i class=\"date\"><!--\$time--></i> ago</summary><div class=\"pre\"><!--\$body--></div><hr></details></li>" -i=index.html -p="journal" -J=data/journal.json -L=!PLATE_JOURNAL)
echo "$new" > index.html
echo "Loaded journal"
